...
function Footer() {
  return (
    <footer
      data-testid="footer"
      className="mb-4 flex flex-wrap justify-center bg-light-1 dark:bg-dark-2"
    >
      <div className="flex flex-col pr-10 text-right text-dark-1 dark:text-light-3">
      ...
      <div className="flex flex-col text-left text-dark-1 underline dark:text-light-3">
