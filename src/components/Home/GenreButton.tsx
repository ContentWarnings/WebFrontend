...
function GenreButton(props: any) {
  return (
    <a
      ...
      className={`flex transition delay-100 ease-in-out ${props.img} rounded border-2 border-transparent bg-cover py-10 hover:border-secondary-2 dark:hover:border-light-1`}
    >
      <div
