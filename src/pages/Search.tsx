...
async function loadNext(
  ...
  try {
    ...
    if (newItems.length === 0) {
      ...
      if (page === 0) {
        newItems.push(
          <p className="my-10 text-center text-2xl">No results found!</p>
        );
      } else {
        newItems.push(
          <p className="my-10 text-center text-2xl">No more results!</p>
        );
      }
    }
...
function Search() {
  ...
  return (
    <div className="mx-auto mt-20 max-w-3xl">
      ...
      <div id="results" className="text-dark-3 dark:text-light-1">
        {items}
        <div
          className={
