    ...
    return (
        <div className="relative mb-10 mt-32 h-fit lg:mx-20">
            <div className="mt-5 text-light-1">
                ...
                <br />
                <p className="text-1xl">MovieMentor ("Application") is an application developed and maintained by Jeffrey DiVincent, Adam Fernandes, Jacob Franz, Nathanael Gaulke, Lauren Morris, and Garrett Spears (the "Developers," "we," "us," "our"). We operate the website moviementor.app (the "Site," "Website"), a suite of mobile applications (the "Apps"), as well as other related products and services that fall under these terms (the "Terms") (collectively, the "Services").</p>
                <br />
                <p className="text-1xl">MovieMentor can be contacted by email at moviementor@divi.sh.</p>
                <br />
                <p className="text-1xl">These Terms constitute a legally binding agreement between you, whether personally or on behalf of an entity ("you"), and the Developers, concerning your use and access to the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Terms.</p>
                <br />
                <p className="text-1xl">The Application and its Developers reserve the right to amend these Terms at any time. Updated Terms will be listed on the Site and be indicated by updating the "Last updated" date on these Terms, and you waive the right to receive specific notice of each such change. It is your responsibility to periodically review these Terms to stay informed up updates. Terms updates are effective immediately on publication.</p>
                <br />
                ...
                <br />
                <p className="text-1xl">The source code of the Apps and the Site are open-sourced under the MIT License. Movie data is provided by The Movie Database (TMDB) and streaming data is provided by JustWatch. We may link to such services to provide additional functionality to you (the User). All user-submitted content is to be irreversibly and perpetually licensed under a CC-0 license; contributors waive their copyrights under the terms of the CC-0 license.</p>
                <br />
                <p className="text-1xl">You are required to own the copyright of any and all submitted content. If you believe any material available on or through the Services violates any copyrights you own or control, please send takedown notices to moviementor.copyright@divi.sh</p>
                <br />
                <p className="text-1xl">MovieMentor, its logo, and the MovieMentor TV Creature are the shared intellectual property of the Developers.</p>
                <br />
                <p className="text-1xl">The Developers are to abide by security best practices and to keep user data safe to our best ability.</p>
                <br />
                <h2 className="text-2xl font-bold">User Registration</h2>
                <br />
                <p className="text-1xl">By creating an account for the Services, you agree that submitted information is accurate, kept up-to-date, and does not perform the following:</p>
                <br />
                ...
                <p className="text-1xl">- Harass, annoy, intimidate, or threaten the Developers or other users of the Services.</p>
                <p className="text-1xl">- Use the Services to advertise or offer to sell goods and services</p>
                <br />
                <p className="text-1xl">We reserve the right to delete any account for any reason. Users cannoy re-create deleted accounts without written consent by the Developers. Users also have the right to request user data stored through the Application and to terminate their own account at any time. User-submitted data will not be deleted automatically on account deletion. These Terms shall remain in full force while you use the Services.</p>
                <br />
                <h2 className="text-2xl font-bold">Services Management</h2>
                <br />
                <p className="text-1xl">We reserve the right, but not the obligation, to:</p>
                <br />
                <p className="text-1xl">- Monitor the Services for violations of these Terms.</p>
                <p className="text-1xl">- Restrict access to the Services at our own discretion.</p>
                <p className="text-1xl">- Add or remove content to the Services.</p>
                <p className="text-1xl">- Otherwise manager the Services to protect our rights and ensure continued operation.</p>
                <br />
                <h2 className="text-2xl font-bold">Privacy Policy</h2>
                <br />
                <span className="text-1xl">We care about data privacy and security, Please review our</span>
                <a href="/privacypolicy" style={{color: "#63a4ff"}}> Privacy Policy</a>
                <span className="text-1xl">. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Terms. Please be advised that our services are based in the United States, but we will make a best effort to comply with European privacy regulations like the Gerneral Data Protection Regulation (GDPR). For more information, contact moviementor.privacy@divi.sh.</span>
                <br />
                <br />
